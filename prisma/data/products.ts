export const products = [
    {
      ...
      {
        name: "Paquete de 3 Rosquillas de Chocolate",
        price: 39.9,
        image: "rosquillas_01",
        categoryId: 4
      },
      {
        name: "Paquete de 3 Rosquillas Glaseadas",
        price: 39.9,
        image: "rosquillas_02",
        categoryId: 4
      },
      {
        name: "Rosquilla de Fresa ",
        price: 19.9,
        image: "rosquillas_03",
        categoryId: 4
      },
      {
        name: "Rosquilla con Galleta de Chocolate ",
        price: 19.9,
        image: "rosquillas_04",
        categoryId: 4
      },
      {
        name: "Rosquilla glass con Chispas Sabor Fresa ",
        price: 19.9,
        image: "rosquillas_05",
        categoryId: 4
      },
      {
        name: "Rosquilla glass con Chocolate ",
        price: 19.9,
        image: "rosquillas_06",
        categoryId: 4
      },
      {
        name: "Rosquilla de Chocolate con MÁS Chocolate ",
        price: 19.9,
        image: "rosquillas_07",
        categoryId: 4
      },
      ...
      {
        name: "Paquete de 3 Rosquillas con Vainilla y Chocolate ",
        price: 39.9,
        image: "rosquillas_09",
        categoryId: 4
      },
      {
        name: "Paquete de 6 Rosquillas Variadas",
        price: 69.9,
        image: "rosquillas_10",
        categoryId: 4
      },
      {
        name: "Paquete de 3 Rosquillas Variadas",
        price: 39.9,
        image: "rosquillas_11",
        categoryId: 4
      },
      {
        name: "Rosquilla Natural con Chocolate",
        price: 19.9,
        image: "rosquillas_12",
        categoryId: 4
      },
      {
        name: "Paquete de 3 Rosquillas de Chocolate con Chispas",
        price: 39.9,
        image: "rosquillas_13",
        categoryId: 4
      },
      {
        name: "Rosquilla Chocolate y Coco",
        price: 19.9,
        image: "rosquillas_14",
        categoryId: 4
      },
      ...
      {
        name: "Trozo Pastel de Chocolate",
        price: 29.9,
        image: "pastel_06",
        categoryId: 5
      },
